...
## Morpho type  
```{r}
# keeps only colums relevant for morpho type classification and sorts them based on their technological class
...
```{r}
# keeps only columns relevant for 'morpho type'Pradnick method' classification and sorts them based on their technological class
...
## Lateralisation
```{r}
# keeps only columns relevant for lateralisation and sorts them based on their technological class
keep_col <- c(2, 4:5, 18)
...
```{r}
# keeps only columns relevant for lateral sharpening spall classification and sorts them based on their technological class
