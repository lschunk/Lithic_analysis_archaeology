...
Pradnick.method <- merged_data[, keep_col] %>% arrange(technological.class)

KM_Pradnick.method <- Pradnick.method[4:333, ] %>% arrange(artefact.state)
PS_Pradnick.method <- Pradnick.method[493:546, ]  %>% arrange(artefact.state)
...
write.xlsx(list(data = merged_data, dimensions = dimensions, KM_dimensions = KM_dimensions,  
                  ...
                  KM_back = KM_back, PS_back = PS_back, KM_morpho.type = KM_morpho.type, 
                  PS_morpho.type = PS_morpho.type, KM_Pradnick.method = KM_Pradnick.method, 
                  PS_Pradnick.method = PS_Pradnick.method, KM_lateralisation = KM_lateralisation, 
