...
KM.edge <- ggplot(data = KM_edge) + aes(x = retouch.type.edge, fill = retouch.type.edge) + 
     geom_bar(stat = "count", width = 0.5, fill = c ("#798E87", "#C27D38", "#972D15", "#29211F")) +
     theme_classic() +
     theme(legend.position = "none") + 
     labs(x = " ", y = "n") 
...
ggsave(filename = file_out, plot = KM.edge, path = dir_out, device = "pdf", width = 170, height = 200, units = "mm")
...
ggsave(filename = file_out, plot = PS.edge, path = dir_out, device = "pdf", width = 170, height = 200, units = "mm")
