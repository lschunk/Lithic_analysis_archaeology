...
## Dimension
```{r}
# keep only columns relevant for dimensions and sorts them based on 
...
KM_Pradnik.method <- Pradnik.method[2:131, ] %>% arrange(artefact.state)
PS_Pradnik.method <- Pradnik.method[174:197, ] %>% arrange(artefact.state)
