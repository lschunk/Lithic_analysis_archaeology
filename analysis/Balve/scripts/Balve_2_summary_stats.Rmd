---
title: 'Summary stats - Lithic analysis Balver Höhle '
author: "Lisa Schunk"
date: "`r Sys.Date()`"
output:
  html_document:
...
* Tool type 
+ state of the tool (Complete, distal/proximal fragment, medial fragment)
...
# width Keilmesser 
KM_width <- summaryBy(.~ ID+artefact.state+width, 
                  data=imp_data, FUN=nminmaxmeanmedsd)
str(KM_width)

# thickness Keilmesser 
KM_thickness <- summaryBy(.~ ID+artefact.state+thickness, 
                  data=imp_data, FUN=nminmaxmeanmedsd)
str(KM_thickness)
```
