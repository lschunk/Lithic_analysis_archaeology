...
KM.morpho.type <- ggplot(data = KM_morpho.type) + aes(x = morpho.type, fill = morpho.type) + 
     geom_bar(stat = "count", width = 0.3, fill = c("#899DA4", "#D76848", "#E8B37B")) +
     theme_classic() +
...
PS.edge <- ggplot(data = PS_edge) + aes(x = retouch.type.edge, fill = retouch.type.edge) + 
     geom_bar(stat = "count", width = 0.5, fill = c ("#972D15", "#29211F")) +
     theme_classic() +
     theme(legend.position = "none") + 
     labs(x = " ", y = "n") 
...
KM.raw_material <- ggplot(data = KM_raw_material) + aes(x = raw.material, fill = raw.material) + 
     geom_bar(stat = "count", width = 0.15, fill = c("#D69C4E", "#046C9A")) +
     theme_classic() +
     theme(legend.position = "none") + 
     labs(x = " ", y = "n") + 
